...
In this inheritance project, I learned about the differences between super- and
sub-classes,definining classes with multiple base classes, and overiding inherited methods
and attributes.
