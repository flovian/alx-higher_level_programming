...
In this project, I learned object-oriented programming:using
classes and objects in Python. I also learned about attributes, methods, and
properties as well as data abstraction and data encapsulation.
